...
<head>
    <meta charset="UTF-8">
    <title>Consultancy Work CSV Upload | Certificate Management System</title>
...
<body>
    ...
    <div class="page-hero">
        ...
        <h2>Consultancy Work <span class="accent">CSV Upload</span></h2>
        <p>Upload a CSV file to bulk-import Faculty Consultancy Work records.</p>
    </div>
