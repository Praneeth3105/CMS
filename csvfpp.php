...
<body>
    ...
    <div class="page-hero">
        ...
        <h2>Paper Publications <span class="accent">CSV</span></h2>
        <p>Upload a CSV file to bulk-import faculty paper publication records.</p>
    </div>
    ...
    if (isset($_FILES['csvFile']) && $_FILES['csvFile']['error'] == 0) {
        ...
        while (($data = fgetcsv($handle, 1000, ",")) !== false) {
            ...
            $volume         = $conn->real_escape_string($volume);
