...
if(isset($_POST['submit'])){
    $sql = "UPDATE bookedited SET authorship_position='$q1',journal='$m',type='t',publication_type='$f',issn='$iss',date='$d',volume='$v',issue='$in',url='$u',file='$filename'  WHERE id='$uname' and  journal='$wnn'";
    // Execute query
