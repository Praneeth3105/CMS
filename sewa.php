...
$stmt = mysqli_prepare($conn, "SELECT * FROM sworkshop WHERE RollNo=? AND WorkShopName=? LIMIT 1");
    ...
    <div class="wrap">
        <div class="card">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="field"><label>Workshop Name</label><input type="text" name="workshopname" value="<?php echo htmlspecialchars($row['WorkShopName']); ?>" required></div>
                <div class="field"><label>Organisation</label><input type="text" name="orgname" value="<?php echo htmlspecialchars($row['OrgName']); ?>" required></div>
                ...
                <div class="field"><label>Place</label><input type="text" name="place" value="<?php echo htmlspecialchars($row['Place']); ?>"></div>
