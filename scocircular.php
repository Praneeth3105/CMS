...
if(isset($_POST['submit'])){
    $sql = "INSERT INTO cocircular (name,rollno,year,branch,eventname,conductingclg,orgname,dates,ie,academic_year,file,counsular,classteacher) VALUES ('$name','$rollno','$year','$branch','$nevent','$condclg','$conorg','$dates','$ie','$acc','$filename','$counsular','$classteacher')";
    // Execute query
