...
<head>
    <meta charset="UTF-8">
    <title>Student Details CSV Upload | Certificate Management System</title>
...
<body>
    ...
    <div class="page-hero">
        ...
        <h2>Student Details <span class="accent">CSV</span></h2>
        <p>Upload a CSV file to bulk-import student detail records.</p>
    </div>
    ...
    if (isset($_FILES['csvFile']) && $_FILES['csvFile']['error'] == 0) {
        ...
        while (($data = fgetcsv($handle, 1000, ",")) !== false) {
            ...
            $domain = isset($data[9]) ? $data[9] : '';
            $startdate = isset($data[6]) ? date('Y-m-d', strtotime($data[6])) : '';
            $enddate = isset($data[7]) ? date('Y-m-d', strtotime($data[7])) : '';
            $duration = isset($data[8]) ? $data[8] : '';
            $place = isset($data[8]) ? $data[8] : '';
