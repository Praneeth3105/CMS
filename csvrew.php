...
<head>
    <meta charset="UTF-8">
    <title>Reviewer CSV Upload | Certificate Management System</title>
...
<body>
    ...
    <div class="page-hero">
        ...
        <h2>Reviewer <span class="accent">CSV Upload</span></h2>
        <p>Upload a CSV file to bulk-import Faculty Reviewer records.</p>
    </div>
