...
<head>
    <meta charset="UTF-8">
    <title>Faculty Workshop CSV Upload | Certificate Management System</title>
...
<body>
    ...
    <div class="page-hero">
        ...
        <h2>Faculty <span class="accent">Workshop CSV</span></h2>
        <p>Upload a CSV file to bulk-import faculty workshop records into the system.</p>
    </div>
