...
{
    $stmt = mysqli_prepare($conn, "SELECT * FROM `professional_membership` WHERE id = ?");
...
<head>
    <meta charset="UTF-8">
    <title>Edit Professional Membership</title>
...
<body>
    <div class="wrap">
        ...
        <div class="subtitle">Table: professional_membership &middot; Record ID: <?php echo htmlspecialchars($id); ?></div>
        ...
        <div class="card">
            ...
            <form method="POST">
                ...
                <div class="field">
                    ...
                    <input type="text" name="membership_name" id="membership_name" value="<?php echo htmlspecialchars($row['membership_name'] ?? ''); ?>">
                </div>

                <div class="field">
                    <label for="membership_id">Membership ID</label>
                    <input type="text" name="membership_id" id="membership_id" value="<?php echo htmlspecialchars($row['membership_id'] ?? ''); ?>">
                </div>

                <div class="field">
                    <label for="membership_type">Membership Type</label>
                    <input type="text" name="membership_type" id="membership_type" value="<?php echo htmlspecialchars($row['membership_type'] ?? ''); ?>">
                </div>
