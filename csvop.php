...
<body>
    ...
    <div class="page-hero">
        ...
        <h2>Outside Participations <span class="accent">CSV Upload</span></h2>
        <p>Upload a CSV file to bulk-import Faculty Conference / Journal records.</p>
    </div>
    ...
    $createTableSql = "CREATE TABLE IF NOT EXISTS outside_participations (
    ...
    VALUES
    (
        '$facultyId', '$academicYear', '$month', '$facultyName', $dateAttendedSql,
