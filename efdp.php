...
if(isset($_POST['submit'])){
    $sql = "UPDATE fdp SET fdpname='$fd', org='$o', place='$place', startdate='$sd', enddate='$ed', duration='$durt', file='$filename'  WHERE id='$uname' and  fdpname='$wnn'";
    // Execute query
