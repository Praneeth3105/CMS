...
<head>
    <meta charset="UTF-8">
    <title>Achievements CSV Upload | Certificate Management System</title>
    ...
    <style>
        ...
        * {
        ...
        /* Per-column widths tuned for the 7 achievement CSV fields */
        col.col-year {
            width: 100px;
        }
...
<body>
    ...
    <div class="page-hero">
        ...
        <h2>Achievements <span class="accent">CSV Upload</span></h2>
        <p>Upload a CSV file to bulk-import Faculty Achievement records.</p>
    </div>
