...
<body>
    ...
    <div class="page-hero">
        ...
        <h2>Faculty Others <span class="accent">CSV</span></h2>
        <p>Upload a CSV file to bulk-import miscellaneous faculty certificate records.</p>
    </div>
    ...
    if (isset($_FILES['csvFile']) && $_FILES['csvFile']['error'] == 0) {
        ...
        while (($data = fgetcsv($handle, 1000, ",")) !== false) {
            ...
            $oo = isset($data[4]) ? $data[4] : '';
            $pl = isset($data[5]) ? $data[5] : '';
            $sd = isset($data[6]) ? date('Y-m-d', strtotime($data[6])) : '';
